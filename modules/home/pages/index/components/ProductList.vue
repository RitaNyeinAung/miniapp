<template>
	<view class="content">
		...
		<view class="goods-list">
          ...
          <image v-if="item.pic_url" :src="config.image_url+item.pic_url" mode="aspectFill"></image>
          <image v-else src="@/static/images/common/img_bad.jpeg" mode="aspectFill"></image>
				</view>
	...
	export default {
		...
		methods: {
			...
			async loadData(type='add', loading) {
				...
				let url = api.getProductListByCategory+
					'?page='+this.currentPage+
					'&attr_type='+this.cateId+
					'&sort_type='+sortOrder+
