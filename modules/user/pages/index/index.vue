		...
		<view class="user-section">
			...
			<view class="user-info-box">
				<view class="portrait-box">
					<image class="portrait" :src="config.image_url+userData.user_header || '/static/missing-face.png'"></image>
				</view>
				<view class="info-box">
					<text class="username">{{userData.user_name || '游客'}}</text>
				</view>
			</view>
		...
		>
			...
			<view class="tj-section">
				<view class="secHeader">
					...
					<text class="orderList1">查看订单</text>
			...
			<view class="order-section">
				...
				<view class="order-item">
					<image class="num" src="@/static/images/common/wdzc.png"></image>
					<text>我的资产</text>
				</view>
			</view>
			<!-- 浏览历史 -->
    ...
    export default {
		...
		data(){
			return {
				...
				navCon: [
					...
					{ num: '0', text: "已完成", imgData: require("@/static/images/common/Orders_04.png") },
					{ num: '0', text: "返修/退货", imgData: require("@/static/images/common/Orders_05.png") }
				],
				navCon3: [
					{text: "0", txt: "可用积分"},
					{text: "0", txt: "优惠卷"},
        ...
        methods: {
			...
			myOrder2(sat) {
				if (sat == 0) {
					uni.navigateTo({
						url: '/modules/user/pages/index/components/orderList?id='+1,
						fail(e) {
							console.log(e)
						}
					})
					...
					uni.navigateTo({
						url: '/modules/user/pages/index/components/orderList?id='+2,
						fail(e) {
							console.log(e)
						}
					})
					...
					uni.navigateTo({
						url: '/modules/user/pages/index/components/orderList?id='+3,
						fail(e) {
							console.log(e)
						}
					})
					...
					uni.navigateTo({
						url: '/modules/user/pages/index/components/orderList?id='+4,
						fail(e) {
							console.log(e)
						}
					})
