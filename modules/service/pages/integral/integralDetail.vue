<template>
	<view class="container">
		<login @logged="refreshData"></login>
		<view class="carousel">
		...
		<view class="introduce-section" v-if="productInfo">
			...
			<view class="price-box">
				<view >
					...
					<text class="coupon-tip" v-if="productInfo.money">金额</text>
					<text class="m-price" v-if="productInfo.money">{{productInfo.money}}元</text>
				</view>
			</view>
			<view class="bot-row">
		...
		<view class="eva-section">
			<view class="e-header">
				<text class="tit">商家咨询</text>
				<text>({{consultCount}})</text>
				<text class="tip" @click="toConsultPage">查看更多</text>
				<text class="yticon icon-you"></text>
			</view>
		...
		<view class="page-bottom">
			...
			<view class="action-btn-group">
				<button type="primary" @click="buy" class=" action-btn no-border buy-now-btn">立即兑换</button>
			</view>
		</view>
...
<script>
	...
	export default{
		...
		async onLoad(options){
			...
			let _this = this;
			uni.request({
				url:api.integralGoodInfo+'?id='+id,
				success: (res) => {
					uni.hideLoading();
					if(res.data.data){
