  ...
  <view>
    <view class="ordinary">
      ...
      <view class="li">
        ...
        <input type="text" class="uni-input" v-model="company_name"/>
      </view>
      <view class="li">
        <label class="txt">税号：</label>
        <input type="text" class="uni-input" v-model="ein"/>
      </view>
      <view class="li">
        <label class="txt">开户银行名称：</label>
        <input type="text" class="uni-input" v-model="opening_bank"/>
      </view>
      <view class="li">
        <label class="txt">开户银行账号：</label>
        <input type="text" class="uni-input" v-model="bank_account"/>
      </view>
      ...
      <view class="li">
        ...
        <input type="text" class="uni-input" v-model="register_address"/>
      </view>
      <view class="li">
        <label class="txt">注册电话：</label>
        <input type="text" class="uni-input" v-model="register_tel"/>
      </view>
    </view>
    <view class="footer">
      <button type="warn"  @click="protact()">确认添加</button>
    </view>
